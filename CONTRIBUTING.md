# Contributing to DevOps Interview Questions
...
The [issue tracker](https://github.com/czerasz/DevOps-Interview-Questions/issues) is the preferred channel for spelling mistakes, errors or any general feedback. Please respect the following restrictions:
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the project, clone your fork, and configure the remotes:
   ...
   git remote add upstream https://github.com/czerasz/DevOps-Interview-Questions.git
   ```
